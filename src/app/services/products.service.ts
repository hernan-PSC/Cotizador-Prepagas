...
@Injectable({ providedIn: 'root' })
 ...
 export class ProductsService {
    // 1. Fuente de datos inicial (JSON)
  public products: any = (planes as any).default; 
    // 2. Lista inicial filtrada
  public productosFiltrados: any[] = this.products; 
    
    // 3. BehaviorSubject inicializado con los datos de referencia (this.products)
  private productosFiltradosSubject: BehaviorSubject<any[]> = new BehaviorSubject<any[]>(this.products);
 ...
 // public secureProducts: any = (planes as any).default; <-- ELIMINADO: ahora se usa public products
  ...
  // Api Data
      ...
      // Si cotizacionService.planes tiene datos en tiempo de ejecución, se sobresscribe el valor
      this.products =this.cotizacionService.planes
      // this.secureProducts =this.cotizacionService.planes <-- ELIMINADO
