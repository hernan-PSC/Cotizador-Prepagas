...
export class ResultsComponent implements OnInit, OnChanges, OnDestroy  {
  ...
  clinicasAgrupadas: any;
  productosList: any; // Si products se usa en otros sitios
...
if(this.previousSelectedItems.length > this.selectedItems.length){
  ...
  async ngOnInit(): Promise<void> {
    ...
    this.productosList = this.compareProdList();
    // 2. Ejecutar la función costosa UNA SOLA VEZ
    this.clinicasAgrupadas = this.compareProdClinicas(this.productosList);
